        ...
        <div>
          ...
          <div className="stat-grid" style={{ marginBottom: '24px' }}>
            ...
            <div className="stat-card" style={{ background: 'var(--primary-light)', borderLeft: '4px solid var(--success)' }}>
              ...
              <div className="stat-value" style={{ color: reportData.summary.totalProfit >= 0 ? 'var(--success)' : 'var(--danger)' }}>
                {formatCurrency(reportData.summary.totalProfit)}
              </div>
              <div style={{ fontSize: '0.75rem', fontWeight: 'bold', color: reportData.summary.totalProfit >= 0 ? 'var(--success)' : 'var(--danger)', marginTop: '2px' }}>
